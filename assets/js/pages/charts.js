...
$(document).ready(function() {
	...
	var chartColours = ['#ff8e05', '#4b89e4', '#01427e', '#bbdce3', '#9a3b1b', '#5a8022', '#2c7282'];
	...
	*/
	...
	$(function () {
		var options = {
			...
			legend:{
				...
				labelFormatter: function(label, series) {
				    return '<div style="font-weight:bold;font-size:13px;font-family:helvetica,san-serif;">'+ label +'</div>'
				},
		...
		var data = [
		    { label: "Gym",  data: 58, color: '#4b89e4'},
		    { label: "Training",  data: 30, color: '#ff8e05'},
		    { label: "Games",  data: 12, color: '#01427e'}
		];
